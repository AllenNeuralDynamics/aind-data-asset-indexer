...
class TestAnalyticsJobRunner(unittest.TestCase):
    ...
    sample_folders_txt = "PRE modality_567890_2000-01-01_04-00-00/\n" \
                         "PRE modality_642478_2023-01-17_13-56-29/\n" \
                         "PRE modality_642478_2023-01-17_14-38-38/\n"

    @patch.dict('os.environ', {'REDSHIFT': 'some_redshift_value',
    ...
    @patch('builtins.open', new_callable=mock_open, read_data=sample_folders_txt)
    def test_create_dataframe_from_list_of_folders(self, mock_file_open):
        ...
        expected_df = pd.DataFrame({'s3_prefix': [
    ...
    def test_create_dataframe_from_metadata_files(self, mock_scandir):
        ...
        mock_scandir.return_value = [
            MockDirEntry(name='modality_567890_2000-01-01_04-00-00', is_dir=True),
            MockDirEntry(name='modality_642478_2023-01-17_13-56-29', is_dir=True),
    ...
    def test_join_dataframes(self):
        """"""
        expected_data = {
            's3_prefix': ['modality_567890_2000-01-01_04-00-00', 'modality_642478_2023-01-17_13-56-29', 'modality_642478_2023-01-17_14-38-38'],
            'metadata_bool': [True, False, True],
            'bucket_name': ['modality_bucket', 'modality_bucket', 'modality_bucket']
        }
        expected_df = pd.DataFrame(expected_data)

        df1_data = {'s3_prefix': ['modality_567890_2000-01-01_04-00-00', 'modality_642478_2023-01-17_13-56-29', 'modality_642478_2023-01-17_14-38-38']}
        df2_data = {'s3_prefix': ['modality_567890_2000-01-01_04-00-00', 'modality_642478_2023-01-17_14-38-38']}
    ...
    def test_crawl_s3_buckets(
            self, mock_join_dataframes, mock_create_metadata_dataframe, mock_create_folders_dataframe,
            mock_download_metadata, mock_get_list_of_folders
    ):
        """"""
        ...
        #     pd.DataFrame({'s3_prefix': [f'{bucket}_folder1', f'{bucket}_folder2']}) for bucket in ['modality1', 'modality2']
        # ]
        mock_get_list_of_folders.side_effect = [None, None]

        mock_create_metadata_dataframe.side_effect = [
            pd.DataFrame({'s3_prefix': [f'{directory}_folder1', f'{directory}_folder2']}) for directory in
            ['dir1', 'dir2']
        ]

        mock_create_folders_dataframe.side_effect = [
            pd.DataFrame({'s3_prefix': [f'{filepath}_folder1', f'{filepath}_folder2']}) for filepath in
            ['file1', 'file2']
        ]
        ...
        mock_join_dataframes.side_effect = [
            pd.DataFrame({'s3_prefix': [f'modality1_folder1', f'modality1_folder2'],
                          'metadata_bool': [True, False],
                          'bucket_name': ['modality1', 'modality1']
            }),
            pd.DataFrame({'s3_prefix': [f'modality2_folder1', f'modality2_folder2'],
                          'metadata_bool': [True, False],
        ...
        expected_data = {
            's3_prefix': ['modality1_folder1', 'modality1_folder2', 'modality2_folder1', 'modality2_folder2'],
            'metadata_bool': [True, False, True, False],
            'bucket_name': ['modality1', 'modality1', 'modality2', 'modality2'],
        }
        expected_df = pd.DataFrame(expected_data)
